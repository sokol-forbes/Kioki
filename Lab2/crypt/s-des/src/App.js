...
function App() {
    ...
    // String Encryption
    const [keyStringValue, setKeyStringValue] = useState(require("./out.json").key);
    const [keyBitsStringArray, setKeyBitsStringArray] = useState([]);
    const [plaintextStringValue, setPlaintextStringValue] = useState( require("./out.json").plaintext);
    ...
    // String Decryption
    const [keyStringDecValue, setKeyStringDecValue] = useState(require("./out.json").key);
    ...
    return (
        ...
        <Container className="container">    
            ...
            <TextField style={{marginRight : '20px', paddingRight:'15px',width:'300px'}} id="outlined-basic" label="10-bit Key" variant="outlined" value={keyStringValue} onChange={onKeyStringChange} />
            <TextField id="outlined-multiline-flexible"  multiline style={{ width:'660px'}}  label="Plaintext string" variant="outlined" value={plaintextStringValue} onChange={onPlaintextStringChange} />
            ...
            <TextField style={{marginRight : '20px',paddingRight:'15px',height:'100%',width:'300px'}} id="outlined-multiline-flexible" multiline variant="outlined" value={ciphertextStringOutput} inputProps={{readOnly: true, }} />
            <TextField id="outlined-multiline-flexible" multiline style={{ width:'660px'}} variant="outlined" value={ciphertextBinStringOutput.join("")} inputProps={{readOnly: true, }} />
            
            <h1>Binary string Decryption: </h1>
            <TextField style={{marginRight : '20px', paddingRight:'15px',width:'300px'}}id="outlined-basic" label="10-bit Key" variant="outlined" value={keyStringDecValue} onChange={onKeyStringDecChange} />
            <TextField id="outlined-multiline-flexible" multiline style={{ width:'660px'}} label="Ciphertext bit-string" variant="outlined" value={ciphertextStringValue} onChange={onCiphertextStringChange} />
            ...
            <h1>Plaintext: </h1>
            <TextField id="outlined-multiline-flexible"  multiline style={{ width:'1000px'}} variant="outlined" value={plaintextStringOutput} inputProps={{readOnly: true, }} />
